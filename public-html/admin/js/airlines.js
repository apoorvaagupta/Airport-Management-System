$(document).ready(function () {
  ...
  $.get('/api/airlines/viewAll', function (airlines) {
    ...
    let airlineslist = $('#airlines-list');
  ...
  $('#airlinesSubmit').click(function () {
    ...
    if (!name || !airline_code) {
      ...
      $.ajax({
        ...
        if (msg === 'Airlines added') {

          $('#addAirlinesModal').modal('hide');
          window.location.reload();
        }
        else {
          console.log("could not add the airlines right now")
        }
      })
